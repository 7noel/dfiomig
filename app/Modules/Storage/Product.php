...
class Product extends Model {
	...
	protected $fillable = ['name', 'intern_code', 'provider_code', 'manufacturer_code', 'description', 'sub_category_id', 'unit_id', 'currency_id', 'size_id', 'code_cut', 'basic_design_id', 'last_purchase', 'profit_margin', 'price', 'set_price', 'use_set_price'];
